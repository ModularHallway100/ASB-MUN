    ...
    <footer className="bg-slate-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">ASBMUN</h3>
            <p className="text-slate-300 mb-4">The Asian School Model United Nations</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:info@asbmun.org" className="text-slate-300 hover:text-white">
                  info@asbmun.org
                </a>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-slate-300" />
                <a href="tel:+911234567890" className="text-slate-300 hover:text-white">
                  +91 12345 67890
                </a>
              </li>
            </ul>
